...
export const widgetSamples: ReadonlyArray<IWidget> = [
  ...
  { id: 30, width: 30, height: 80 },
  { id: 35, width: 35, height: 15 },
  { id: 40, width: 40, height: 95 },
  { id: 50, width: 50, height: 50 },
  { id: 45, width: 45, height: 34 },
  { id: 55, width: 55, height: 17 },
  { id: 60, width: 60, height: 96 },
  { id: 65, width: 65, height: 24 },
  { id: 70, width: 70, height: 41 },
  { id: 75, width: 75, height: 64 },
  { id: 80, width: 80, height: 39 },
  { id: 85, width: 85, height: 54 },
  { id: 90, width: 90, height: 67 },
  { id: 95, width: 95, height: 105 },
  { id: 100, width: 100, height: 41 },
];
